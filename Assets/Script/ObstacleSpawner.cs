...
public class ObstacleSpawner : MonoBehaviour
{
    ...
    public void SpawnObstacles(Transform position)
    {
        ...
        Vector3 randomPosition = position.position + new Vector3(randomPosX, 0, randomPosZ);
        ...
        obstacle.ReturnObstacleAction(() =>
        {
            RecycleObstacle(ramdomType, obstacleGO);
        });
        Init(ramdomType,obstacleGO);

    }

    private void RecycleObstacle(int i, GameObject go)
    {
